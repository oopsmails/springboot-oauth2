...
insert into carts(userId, cartType) values (1000, 'ONLINE');
insert into carts(userId, cartType) values (1000, 'STORE');
insert into carts(userId, cartType) values (1001, 'ONLINE');
